...
def onCommandMb(sender,args):
    ops = open('/plugins/ThunderUtils.py.dir/plugins/ThunderUtils.py.dir/ops.txt')
    ...
    ops.close()
    if args[0] == 'list':
        b = open('/plugins/ThunderUtils.py.dir/plugins/ThunderUtils.py.dir/Binds.py',"r")
    ...
    if args[0] == 'confirmdelete':
        if ResetAllPending.count(sender.getName()) == 1:
            b = open('/plugins/ThunderUtils.py.dir/plugins/ThunderUtils.py.dir/Binds.py','w')
            c = open('/plugins/ThunderUtils.py.dir/plugins/ThunderUtils.py.dir/Template.txt')
    ...
    if args[0] == 'cancel':
        ...
        return False
    if args[0] == 'delete':
        b = open('/plugins/ThunderUtils.py.dir/plugins/ThunderUtils.py.dir/Binds.py')
...
def complie(sender,args):
    ...
    a = []
    b = open('/plugins/ThunderUtils.py.dir/plugins/ThunderUtils.py.dir/Binds.py','a')
    b.write('#{}\n'.format(CommandName))
