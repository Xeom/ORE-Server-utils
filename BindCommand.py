...
def onCommandMb(sender,args):
    ops = open('\servers\thunder\plugins\ThunderUtils.py.dir\RandomFiles\ops.txt')
    ...
    ops.close()
    if args[0] == 'list':
        b = open('\servers\thunder\plugins\ThunderUtils.py.dir\RandomFiles\Binds.py',"r")
    ...
    if args[0] == 'confirmdelete':
        if ResetAllPending.count(sender.getName()) == 1:
            b = open('\servers\thunder\plugins\ThunderUtils.py.dir\RandomFiles\Binds.py','w')
            c = open('\servers\thunder\plugins\ThunderUtils.py.dir\RandomFiles\Template.txt')
    ...
    if args[0] == 'cancel':
        ...
        return False
    if args[0] == 'delete':
        b = open('\servers\thunder\plugins\ThunderUtils.py.dir\RandomFiles\Binds.py')
...
def complie(sender,args):
    ...
    a = []
    b = open('\servers\thunder\plugins\ThunderUtils.py.dir\RandomFiles\Binds.py','a')
    b.write('#{}\n'.format(CommandName))
