...
M.setDisplayName(''.join([u'\u00A7',"dDark Ingot"]))
DARK_INGOT.setItemMeta(M)
DARK_INGOT.addUnsafeEnchantment(ench.KNOCKBACK, 8)

FIREY_MAGICIANS_POWDER = i(Material.SUGAR, 1, 3)
M = DARK_INGOT.getItemMeta()
M.setDisplayName(''.join([u'\u00A7',"dDark Ingot"]))
DARK_INGOT.setItemMeta(M)
DARK_INGOT.addUnsafeEnchantment(ench.KNOCKBACK, 8)

REFINED_FIREY_MAGICIANS_POWDER = i(Material.REDSTONE, 1, 3)
M = DARK_INGOT.getItemMeta()
M.setDisplayName(''.join([u'\u00A7',"dDark Ingot"]))
DARK_INGOT.setItemMeta(M)
DARK_INGOT.addUnsafeEnchantment(ench.KNOCKBACK, 8)
...
R = s(ICEY_SHARD)
R.addIngredient(Material.SNOW_BALL, 0)
R.addIngredient(Material.NETHER_BRICK_ITEM, 1)
